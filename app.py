...
# ------------------ LOAD CHECKPOINT ------------------
checkpoint_path = os.path.join(config['training']['save_path'], "checkpoint_epoch8.pth")
...
if uploaded_file is not None:
    ...
    # Create two columns: left for image, right for caption
            ...
            st.markdown(
                ...
                '>
                    <p style='color: rgba(255,255,255,0.8); font-size: 18px; margin: 0;'>
                        👈 Click the button in the sidebar to generate a caption
                    </p>
                </div>
                """,
                unsafe_allow_html=True
    ...
    st.markdown("""
        ...
        '>
            ...
            <p style='color: rgba(255,255,255,0.8); font-size: 18px;'>
                Please upload an image from the sidebar to get started
            </p>
        </div>
    """, unsafe_allow_html=True)